...
<img src="README.assets/image-20260219213213953.png" alt="image-20260219213213953" style="zoom:67%;" />
...
![image-20260219213732788](README.assets/image-20260219213732788.png)
...
<img src="README.assets/image-20260219214029443.png" alt="image-20260219214029443" style="zoom: 67%;" />
...
<img src="README.assets/image-20260219214235584.png" alt="image-20260219214235584" style="zoom: 67%;" />
...
![image-20260219214641496](README.assets/image-20260219214641496.png)
...
![image-20260219214832606](README.assets/image-20260219214832606.png)
...
<img src="README.assets/image-20260219214949665.png" alt="image-20260219214949665" style="zoom: 67%;" />
...
<img src="README.assets/image-20260219215707225.png" alt="image-20260219215707225" style="zoom:67%;" />

![image-20260219215549639](README.assets/image-20260219215549639.png)

#### 2.二级页表

![image-20260219215738112](README.assets/image-20260219215738112.png)
...
![image-20260219215843850](README.assets/image-20260219215843850.png)
...
![image-20260219220511353](README.assets/image-20260219220511353.png)
...
![image-20260219220553668](README.assets/image-20260219220553668.png)
...
键盘是中断驱动设备。
中断触发后从端口 0x60 读取扫描码。
扫描码分为通码和断码，最高位为 1 表示断码。
对于断码，只更新功能键状态。
对于通码，根据是否为扩展扫描码（0xE0 开头）进行合并。
再通过 keymap 将扫描码转换为 ASCII。
同时根据 shift 和 caps_lock 的状态决定字符大小写。
整个驱动本质是一个基于扫描码的状态机实现。

<img src="README.assets/image-20260220200404307.png" alt="image-20260220200404307" style="zoom: 50%;" />

#### 6.基于环形缓冲区的阻塞式生产者–消费者 IO 队列是如何实现的？

使用环形数组作为缓冲区，定义 head 和 tail。

通过 head == tail 判断空，
通过 next(head) == tail 判断满。

 添加 lock 保护临界区。

如果队列为空，消费者调用 thread_block 阻塞自己；
如果队列已满，生产者阻塞。
